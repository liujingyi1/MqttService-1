...
public class SocketFactory extends SSLSocketFactory {
    ...
    public static SSLSocketFactory getSocketFactory() {
        try {
            ...
            ks.load(MqttApplication.getApplication().getResources().openRawResource(R.raw.tsl), MqttConstants.BKS_PASSWORD.toCharArray());
            tks.load(MqttApplication.getApplication().getResources().openRawResource(R.raw.tsl), MqttConstants.BKS_PASSWORD.toCharArray());
